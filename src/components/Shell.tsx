    ...
    <div className="flex h-screen overflow-hidden bg-bg">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="min-h-0 flex-1 overflow-y-auto">
          {/* Keyed on pathname → fresh mount + enter animation on each navigation.
              (No AnimatePresence "wait" here: it stalled the incoming route behind
              the outgoing page's exit animation, so pages only appeared after a refresh.) */}
          <motion.div
            key={loc.pathname}
