  ...
  return (
    <div className={cn('flex items-center gap-2.5', className)}>
      ...
      <div className="leading-none">
        <div className="text-[15px] font-semibold tracking-tight text-content">Rodic AssetSpace</div>
        <div className="mt-0.5 text-[10px] font-medium uppercase tracking-[0.14em] text-subtle">Workplace &amp; Assets</div>
      </div>
    </div>
  )
}
